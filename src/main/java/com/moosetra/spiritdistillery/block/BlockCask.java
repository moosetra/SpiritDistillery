...
import com.moosetra.spiritdistillery.tileentity.TileEntityCask;
...
public class BlockCask extends BlockTileEntitySD
{
    public BlockCask()
    {
        super(Material.wood);
    ...
    {
        return new TileEntityCask();
    }

    @Override
    public int getRenderType()
    {
        return RenderIds.cask;
    }
