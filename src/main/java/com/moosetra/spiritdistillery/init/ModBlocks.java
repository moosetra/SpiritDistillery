...
public class ModBlocks
{
    ...
    public static final BlockTileEntitySD Cask = new BlockCask();
    public static final BlockTileEntitySD AgingBarrel = new BlockAgingBarrel();
    ...
    public static final BlockTileEntitySD CarboniteTank = new BlockCarboniteTank();
    public static final BlockSD RedMaplePlanks= new BlockRedMaplePlanks();
    public static final BlockTileEntitySD Fermenter = new BlockFermenter();
    public static final BlockTileEntitySD Barrel = new BlockBarrel();
