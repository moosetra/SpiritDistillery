...
public class RenderFermenter extends TileEntitySpecialRenderer implements IItemRenderer {
    public ModelFermenter model;
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float scale)
    {
        ...
        this.bindTexture(Textures.Model.FERMENTER);
